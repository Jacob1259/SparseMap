...
dimensions = {'C': 128, 'M': 128, 'N': 1, 'P': 16, 'Q': 16, 'R': 3, 'S': 3}
JOB = "resnet_conv"              #高层次
...
def strenthen(individual):
    ...
    optimizer = ng.optimizers.OnePlusOne(parametrization=instrum, budget=100, num_workers=10)
    ...
    new_perform = target(recommendation.value[1]['map_code'],recommendation.value[1]['perm_code'],recommendation.value[1]['bypass_choice'],recommendation.value[1]['split'])
...
def main():
    initialize_path = "/home/workspace/2022.micro.artifact/multiSCNN/sparsemap_single/resnet_conv_mapping_found/workload_resnet_conv4_initialize.csv"
    population = population_initialize(initialize_path)
